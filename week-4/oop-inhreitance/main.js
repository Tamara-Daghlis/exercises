...
class Principal extends Person {
    ...
    expelStudent(student) {
       for (let studentIndex in this.students){
          if(student.name == this.students[studentIndex].name) {
    ...
    transferStudent(student , principal) {
        const studentToPricipal = this.students.find(s => s.name == student.name)
        principal.students.push(studentToPricipal)
    }
}
